...
npm_fmt = '{0.mention} Sorry, the `{2}{1}` command only works in guilds.'
ccd_fmt = '{0.mention} Sorry, the `{2}{1}` command is currently disabled.'
cpe_fmt = '{0.mention} Sorry, you don\'t have enough **permissions** for `{2}{1}`! You need **{3}**.'
ocpe_fmt = '{0.mention} Sorry, you don\'t have enough **permissions** for `{2}{1}`! **{3}** will work.'
emp_msg = '{0.mention} The bot tried to send an empty message for `{2}{1}`.'
msg_err = '{0.mention} Something went wrong while responding to `{2}{1}`. Maybe try again? `{3}`'
nam_err = '{0.mention} Variable `{3}` wasn\'t defined while responding to `{2}{1}`.'
big_msg = '{0.mention} Something went wrong responding to `{2}{1}`. The message is probably too long.'
tim_err = '{0.mention} Responding to `{2}{1}` failed, because the request took too long!'
arg_err = '{0.mention} You used `{2}{1}` with{4}. Here\'s the correct usage:\n`{3}`'
coc_fmt = '{0.mention} You\'re on cooldown for `{2}{1}`. Try again in **{3}**.'
